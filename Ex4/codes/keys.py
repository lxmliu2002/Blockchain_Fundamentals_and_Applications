...
alice_secret_key_BTC = CBitcoinSecret(
    'cUpCNaMwCphDA1NRoeFiSNQhQghDAHCiKnAHjsAYhtC7brHWxSLu')

# Only to be imported by bob.py
bob_secret_key_BTC = CBitcoinSecret(
    'cVe2gjMb76HjG8Wr5bU3CUruccBLxPLxE7uDmt5rneDRRcPaXcTZ')
...
alice_secret_key_BCY = CBitcoinSecret.from_secret_bytes(
    x('3991895a89e87b2b8284eddfa29d25317a694f6a3dd82596581eefc9b101da5b'))

# Only to be imported by bob.py
# Bob should have coins!!
bob_secret_key_BCY = CBitcoinSecret.from_secret_bytes(
    x('221d9a49929481c2c2a253dd08f3a1046e66df654bd1e65809b1b75624cee0a4'))
